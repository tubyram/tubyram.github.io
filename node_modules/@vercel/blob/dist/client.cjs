...
var _chunkQNGLQ5FJcjs = require('./chunk-QNGLQ5FJ.cjs');
...
function createPutExtraChecks(methodName) {
  return function extraChecks(options) {
    if (!options.token.startsWith("vercel_blob_client_")) {
      throw new (0, _chunkQNGLQ5FJcjs.BlobError)(`${methodName} must be called with a client token`);
    }
    if (
      ...
      throw new (0, _chunkQNGLQ5FJcjs.BlobError)(
...
var put = _chunkQNGLQ5FJcjs.createPutMethod.call(void 0, {
  allowedOptions: ["contentType"],
  extraChecks: createPutExtraChecks("client/`put`")
});
var createMultipartUpload = _chunkQNGLQ5FJcjs.createCreateMultipartUploadMethod.call(void 0, {
  allowedOptions: ["contentType"],
  extraChecks: createPutExtraChecks("client/`createMultipartUpload`")
});
var createMultipartUploader = _chunkQNGLQ5FJcjs.createCreateMultipartUploaderMethod.call(void 0, 
  {
    allowedOptions: ["contentType"],
    extraChecks: createPutExtraChecks("client/`createMultipartUpload`")
  }
);
var uploadPart = _chunkQNGLQ5FJcjs.createUploadPartMethod.call(void 0, {
  allowedOptions: ["contentType"],
  extraChecks: createPutExtraChecks("client/`multipartUpload`")
});
var completeMultipartUpload = _chunkQNGLQ5FJcjs.createCompleteMultipartUploadMethod.call(void 0, 
  {
    allowedOptions: ["contentType"],
    extraChecks: createPutExtraChecks("client/`completeMultipartUpload`")
  }
);
var upload = _chunkQNGLQ5FJcjs.createPutMethod.call(void 0, {
  allowedOptions: ["contentType"],
  extraChecks(options) {
...
async function handleUpload({
  ...
  var _a, _b, _c, _d;
  const resolvedToken = _chunkQNGLQ5FJcjs.getTokenFromOptionsOrEnv.call(void 0, { token });
  ...
  switch (type) {
    ...
    case "blob.upload-completed": {
      ...
      if (!signature) {
        throw new (0, _chunkQNGLQ5FJcjs.BlobError)("Missing callback signature");
      }
      ...
      if (!isVerified) {
        throw new (0, _chunkQNGLQ5FJcjs.BlobError)("Invalid callback signature");
      }
      await onUploadCompleted(body.payload);
      return { type, response: "ok" };
    }
    default:
      throw new (0, _chunkQNGLQ5FJcjs.BlobError)("Invalid event type");
  }
}
async function retrieveClientToken(options) {
  ...
  if (!res.ok) {
    throw new (0, _chunkQNGLQ5FJcjs.BlobError)("Failed to  retrieve the client token");
  }
  try {
...
async function generateClientTokenFromReadWriteToken({
  ...
  const readWriteToken = _chunkQNGLQ5FJcjs.getTokenFromOptionsOrEnv.call(void 0, { token });
  ...
  if (!securedKey) {
    throw new (0, _chunkQNGLQ5FJcjs.BlobError)("Unable to sign client token");
  }
